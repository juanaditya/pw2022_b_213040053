...
$o = query("SELECT * FROM obat WHERE id =$id")[0];
...
<blockquote class="blockquote">
    ...
    <input type="hidden" name="id" value="<?= $o["id"];?>">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" name="nama" id="nama" value="<?= $o["nama"];?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" name="keterangan" id="keterangan" value="<?= $o["keterangan"];?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" name="perusahaan" id="perusahaan" value="<?= $o["perusahaan"];?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" name="dosis" id="dosis" value="<?= $o["dosis"];?>">
            </div>
        </div>
